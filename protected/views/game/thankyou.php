...
<!--                    <p style='font-size: 10px; margin: 0px 0px 5px;'><?php echo Yii::t('youtoo', 'Each Friday, Client will air a Futbol Match. You have to pick the winner. It\'s only $1.00 to select<br/>your answer. If you are right, then your will entered to win the weekly prize for this game.'); ?></p>
            ...
            <div class="col-sm-12" style="padding-right: 0px; padding-left: 0px; left: -23px;top: -50px;">
                <div class="form" style="position: relative; top: -10px; min-width: 823px; background: url('/webassets/images/laliga/image_game-background.png') no-repeat; min-height: 600px; clear: both;">
                    ...
                    <div class="game" class="fab-left fab-voting-left" style='clear: both;'>
                        ...
                        echo '<div class="question col-sm-10 col-sm-offset-1" style="font-size: 23px; font-weight: 500; padding-top: 30px; color: #ffffff; margin-bottom: 30px;">' . 'Do you wish to continue?' . '</div>';
                        //$answerArray = Array();
                        //$answerAutoArray = Array();
                        //$i = 1;?>
                        <a href="/multiplechoice/<?php echo $subgameId?>"><button class="btn btn-default btn-md" style="margin-right: 20px;" id="goToShareLocation">Yes, take me to next game</button></a>
                        <a href="<?php echo Yii::app()->createUrl('/site/index'); ?>"><button class="btn btn-default btn-md" id="notShareLocation">No, take me home</button></a>
